                                ...
                                <div class="accordion__body">
                                    <div class="paymentinfo">
                                        <div class="single-method">
                                            <input type="radio" name="payment_type" value="COD" required /><span
                                                class="cod">Cash On Delivery</span>
                                            &nbsp;&nbsp;
                                            <input type="radio" name="payment_type" value="bKash" required /><span
                                                class="cod">bKash</span>
                                            <input type="radio" name="payment_type" value="Nagad" required /><span
                                                class="cod">Nagad</span>
